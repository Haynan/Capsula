...
class ProductSeeder extends Seeder
{
    ...
    {
        $products = [
            ['name' => 'Seguro de Veículos', 'short_description' => 'Proteção completa para o seu automóvel.', 'is_featured' => true],
            ...
            ['name' => 'Seguro Empresarial', 'short_description' => 'Proteja operação, patrimônio e continuidade do negócio.', 'is_featured' => true],
