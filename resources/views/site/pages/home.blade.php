        ...
        <div class="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
            <div class="capsula-glass overflow-hidden p-8 lg:p-12">
                ...
                <div class="mt-10 grid gap-4 md:grid-cols-3">
                    ...
                    <div class="rounded-3xl border border-white/70 bg-white/80 p-5">
                        ...
                        <p class="mt-3 text-sm leading-7 text-[var(--capsula-600)]">Locação de longo prazo e assinatura com previsibilidade para pessoa física e empresa.</p>
                    </div>
                    <div class="rounded-3xl border border-white/70 bg-white/80 p-5">
            ...
            <div class="capsula-card">
                ...
                <div class="mt-6 grid gap-4 sm:grid-cols-2">
                    <div class="rounded-3xl bg-[var(--capsula-900)] px-5 py-4 text-white">
                        <p class="text-xs uppercase tracking-[0.3em] text-white/50">Site + operação</p>
                        <p class="mt-2 text-sm leading-7 text-white/80">Uma base enxuta para captar, organizar e acompanhar cada oportunidade.</p>
                    </div>
                    <div class="rounded-3xl bg-[var(--capsula-50)] px-5 py-4">
                        <p class="text-xs uppercase tracking-[0.3em] text-[var(--capsula-400)]">Confiança</p>
                        <p class="mt-2 text-sm leading-7 text-[var(--capsula-600)]">Visual sóbrio, linguagem clara e posicionamento premium.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="sobre" class="capsula-container py-10 lg:py-16">
        <div class="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
            ...
            <div class="capsula-card grid gap-5 text-sm leading-8 text-[var(--capsula-600)]">
                <p>A Cápsula Corretora organiza seguros, consórcios, saúde e locação de longo prazo com uma abordagem consultiva e objetiva. Cada indicação parte do contexto real do cliente, sem promessas exageradas e sem complexidade desnecessária.</p>
        ...
        <div class="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            @foreach ($featuredProducts as $product)
                <article class="capsula-card">
                    <p class="capsula-section-kicker">Produto em destaque</p>
